const Seeyou = () => {
  ...
  const cont1 =$("<div class='container'><div class='row'><div class='col-xs-12 col-sm-12 container-flex-row'><div class=''><img src='bagSeeyou.png' height='500px' width='500px'></div></div></div></div>");
  ...
  const txt = $("<span>We look forward to seeing you there on the</span>");
