...
const  Yourbasket = (update) => {
 ...
 "<div class='col-xs-10 col-sm-10 container-flex-row'><h3 class='marginTop'>Tu bolsa de compras (<span id='nItems'></span>)</h3></div></div>");
 ...
 const btn_comprar=$('<button class="btn btn-danger btn-lg boton" type="button" name="button">Buy</button>');
 const btn_cita=$('<button class="btn btn-danger btn-lg boton"type="button" name="button">Cita</button>');
